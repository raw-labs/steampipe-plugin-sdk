...
func (c *wrapperPluginClient) EstablishMessageStream(ctx context.Context, in *EstablishMessageStreamRequest, opts ...grpc.CallOption) (WrapperPlugin_EstablishMessageStreamClient, error) {
	...
	stream, err := c.cc.NewStream(ctx, &WrapperPlugin_ServiceDesc.Streams[0], WrapperPlugin_EstablishMessageStream_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &wrapperPluginEstablishMessageStreamClient{ClientStream: stream}
...
func (c *wrapperPluginClient) GetSchema(ctx context.Context, in *GetSchemaRequest, opts ...grpc.CallOption) (*GetSchemaResponse, error) {
	...
	err := c.cc.Invoke(ctx, WrapperPlugin_GetSchema_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperPluginClient) Execute(ctx context.Context, in *ExecuteRequest, opts ...grpc.CallOption) (WrapperPlugin_ExecuteClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &WrapperPlugin_ServiceDesc.Streams[1], WrapperPlugin_Execute_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &wrapperPluginExecuteClient{ClientStream: stream}
	if err := x.ClientStream.SendMsg(in); err != nil {
		return nil, err
	}
	if err := x.ClientStream.CloseSend(); err != nil {
...
func (c *wrapperPluginClient) SetConnectionConfig(ctx context.Context, in *SetConnectionConfigRequest, opts ...grpc.CallOption) (*SetConnectionConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, WrapperPlugin_SetConnectionConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperPluginClient) SetAllConnectionConfigs(ctx context.Context, in *SetAllConnectionConfigsRequest, opts ...grpc.CallOption) (*SetConnectionConfigResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SetConnectionConfigResponse)
	err := c.cc.Invoke(ctx, WrapperPlugin_SetAllConnectionConfigs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperPluginClient) UpdateConnectionConfigs(ctx context.Context, in *UpdateConnectionConfigsRequest, opts ...grpc.CallOption) (*UpdateConnectionConfigsResponse, error) {
	...
	err := c.cc.Invoke(ctx, WrapperPlugin_UpdateConnectionConfigs_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperPluginClient) GetSupportedOperations(ctx context.Context, in *GetSupportedOperationsRequest, opts ...grpc.CallOption) (*GetSupportedOperationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, WrapperPlugin_GetSupportedOperations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperPluginClient) SetCacheOptions(ctx context.Context, in *SetCacheOptionsRequest, opts ...grpc.CallOption) (*SetCacheOptionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, WrapperPlugin_SetCacheOptions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperPluginClient) SetRateLimiters(ctx context.Context, in *SetRateLimitersRequest, opts ...grpc.CallOption) (*SetRateLimitersResponse, error) {
	...
	err := c.cc.Invoke(ctx, WrapperPlugin_SetRateLimiters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperPluginClient) GetRateLimiters(ctx context.Context, in *GetRateLimitersRequest, opts ...grpc.CallOption) (*GetRateLimitersResponse, error) {
	...
	err := c.cc.Invoke(ctx, WrapperPlugin_GetRateLimiters_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *wrapperPluginClient) SetConnectionCacheOptions(ctx context.Context, in *SetConnectionCacheOptionsRequest, opts ...grpc.CallOption) (*SetConnectionCacheOptionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, WrapperPlugin_SetConnectionCacheOptions_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _WrapperPlugin_EstablishMessageStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(WrapperPluginServer).EstablishMessageStream(m, &wrapperPluginEstablishMessageStreamServer{ServerStream: stream})
}
...
func _WrapperPlugin_Execute_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(WrapperPluginServer).Execute(m, &wrapperPluginExecuteServer{ServerStream: stream})
}
